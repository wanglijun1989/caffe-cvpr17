...
./build/tools/caffe train -solver=examples/cvpr17-ILT-pretrain-fs/solver.prototxt -weights=/home/lijun/Research/Code/CVPR17/model/vgg16CAM_train_iter_90000.caffemodel -gpu=0,1 2>&1 1>ip1 | tee examples/cvpr17-ILT-pretrain-fs/log-ip-1.txt
