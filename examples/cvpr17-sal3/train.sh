...
./build/tools/caffe train -solver=examples/cvpr17-sal3/solver.prototxt -weights=models/cvpr17-ILT/ILT-3_iter_6000.caffemodel   2>&1 | tee examples/cvpr17-sal3/log-sal3-1-2.txt 
