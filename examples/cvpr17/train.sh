#./build/tools/caffe train -solver=examples/cvpr17/solver.prototxt -weights=/home/lijun/Research/Code/FCT_scale_base/model/VGG_ILSVRC_16_layers.caffemodel -gpu=0,1 2>&1 | tee examples/cvpr17/log-smooth-6.txt 
