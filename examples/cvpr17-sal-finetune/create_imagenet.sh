...
MAP_ROOT=/home/lijun/Research/DataSet/ILSVRC2014/ILSVRC2014_DET/sal_map_merged/sal_map/ILSVRC2014_DET_train/
...
#    $TRAIN_DATA_ROOT \
#    $TRAIN_LIST_PATH/train_sal_img_shuffled.txt \
#    $LMDB_PATH/ilsvrc14_train_sal_img_lmdb


echo "Creating train map lmdb..."
rm $LMDB_PATH/ilsvrc14_train_sal_map_lmdb -r
#
GLOG_logtostderr=1 $TOOLS/convert_imageset \
    --resize_height=$RESIZE_HEIGHT \
    --resize_width=$RESIZE_WIDTH \
    ...
    $MAP_ROOT \
    $TRAIN_LIST_PATH/train_sal_img_shuffled.txt \
    $LMDB_PATH/ilsvrc14_train_sal_map_lmdb
