...
#./build/tools/caffe train -solver=examples/cvpr17-ILT-pretrain-exp1/solver.prototxt -weights=/home/lijun/Research/Code/CVPR17/model/vgg16CAM_train_iter_90000.caffemodel -gpu=0,1 2>&1 | tee examples/cvpr17-ILT-pretrain-exp1/log-ip-1.txt
#resotre from iter 4000
./build/tools/caffe train -solver=examples/cvpr17-ILT-pretrain-exp1/solver.prototxt -snapshot=models/cvpr17-ILT-pretrain-exp1/ip-1_iter_4000.solverstate -gpu=0 2>&1 | tee examples/cvpr17-ILT-pretrain-exp1/log-ip-1-1.txt 
